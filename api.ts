...
export class PetApi {
    ...
    public findPetsByStatus (status: string) : Promise<{ response: http.ClientResponse; body: Array<Pet>;  }> {
    ...
    public uploadFile (petId: number, additionalMetadata?: string, file?: any) : Promise<{ response: http.ClientResponse; body: ApiResponse;  }> {
        ...
        let deferred = promise.defer<{ response: http.ClientResponse; body: ApiResponse;  }>();
